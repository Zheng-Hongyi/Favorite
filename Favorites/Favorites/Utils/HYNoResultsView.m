...
@implementation HYNoResultsView
...
+ (instancetype)noResultsViewWithTitle:(NSString *)titleText message:(NSString *)messageText accessoryView:(UIView *)accessoryView buttonTitle:(NSString *)buttonTitle {
    ...
    HYNoResultsView *noResultsView  = [HYNoResultsView new];
...
- (void)orientationDidChange:(NSNotification *)notification {
    ...
    _accessoryView.hidden   = (UIDeviceOrientationIsLandscape(device.orientation) && [ [ [ UIDevice currentDevice ] model ] isEqualToString: @"iPhone" ]);
